import { BarChart3, CalendarDays, FileCheck2, Heart, MapPin, Search, Settings, UserRound, Users, Wrench } from 'lucide-react'
...
export default function App() {
  ...
  const providerLinks = [
    { to: 'profile', label: 'Profile', icon: UserRound },
    { to: 'skills', label: 'Skills & pricing', icon: Wrench },
    { to: 'addresses', label: 'Service areas', icon: MapPin },
    ...
    <Route element={<ProtectedRoute/>}>
      ...
      <Route element={<RoleRoute allowedRoles={[ROLES.PROVIDER]}/>}>
        <Route path="provider" element={<DashboardLayout title="Provider account" links={providerLinks}/>}>
          ...
          <Route path="skills" element={<ProviderSkills/>}/>
          <Route path="addresses" element={<ProviderAddresses/>}/>
